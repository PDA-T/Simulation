...
public class Caidanlan {
	...
	public static JMenuItem zcd_moren=new JMenuItem("√切换默认模式");
	public static JMenuItem zcd_Adobe=new JMenuItem("切换Adobe模式");
	public static JMenuItem zcd_Steam=new JMenuItem("切换Steam模式");
	public static int anz_quanju=0;// 创建按钮组总计
	public Caidanlan() {
		JMenuBar menuBar = new JMenuBar();// 创建菜单栏
		Main_package.Main_form.frame.setJMenuBar(menuBar);// 添加菜单栏
		...
		zcd_moren.addActionListener(new ActionListener() {// 默认模式按钮
			public void actionPerformed(ActionEvent e) {
				if (zcd_moren.getText().equals("√切换默认模式")){
					...
					zcd_moren.setText("√切换默认模式");
					zcd_Steam.setText("切换Steam模式");
